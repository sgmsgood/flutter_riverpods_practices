...
import 'package:flutter_riverpod_inflearn/riverpods/state_provider.dart';
      ...
      body: SizedBox(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ref.read(numberProvider.notifier).state = ref.read(numberProvider.notifier).update((state) => state - 1);
              },
              child: Text('Down'),
            ),
